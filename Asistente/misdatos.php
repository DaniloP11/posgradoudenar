...
$query_coordinador = mysqli_query($con, "SELECT * FROM asistentes WHERE correo = '$email'");
...
<html lang="en">
    ...
    <title>Mis datos Asistente</title>
    ...
    <div class="col-3">
        ...
        <div class="container-fluid">
            ...
            <div class="offcanvas-body">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="InicioAsiste.php">Inicio</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="UsuariosAsiste.html">Usuarios</a>
                </li>
                <li class="nav-item">
